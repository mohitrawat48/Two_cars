...
module lab8_soc_mm_interconnect_0 (
		...
		input  wire        otg_hpi_cs_reset_reset_bridge_in_reset_reset,   //   otg_hpi_cs_reset_reset_bridge_in_reset.reset
	...
	wire   [12:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> keycode_s1_agent:cp_channel
	...
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> otg_hpi_data_s1_agent:cp_data
	...
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> otg_hpi_r_s1_agent:cp_data
	...
	wire  [106:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> sdram_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                              // sdram_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [12:0] cmd_mux_012_src_channel;                                                            // cmd_mux_012:src_channel -> sdram_s1_agent:cp_channel
	...
	wire  [106:0] otg_hpi_data_s1_agent_rp_data;                                                      // otg_hpi_data_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [106:0] otg_hpi_r_s1_agent_rp_data;                                                         // otg_hpi_r_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [106:0] sdram_s1_agent_rp_data;                                                             // sdram_s1_agent:rp_data -> router_014:sink_data
	...
	wire   [12:0] cmd_demux_src12_channel;                                                            // cmd_demux:src12_channel -> crosser:in_channel
	...
	wire   [12:0] crosser_out_channel;                                                                // crosser:out_channel -> cmd_mux_012:sink0_channel
	...
	wire   [12:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_012:sink1_channel
	...
	wire   [12:0] rsp_demux_012_src0_channel;                                                         // rsp_demux_012:src0_channel -> crosser_002:in_channel
	...
	wire   [12:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink12_channel
	...
	wire   [12:0] rsp_demux_012_src1_channel;                                                         // rsp_demux_012:src1_channel -> crosser_003:in_channel
	...
	wire   [33:0] sdram_s1_agent_rdata_fifo_out_data;                                                 // sdram_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_012:in_0_data
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                //                      clk.clk
		.reset                  (otg_hpi_cs_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (otg_hpi_cs_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_router_002 router_006 (
	...
	lab8_soc_mm_interconnect_0_router_002 router_007 (
	...
	lab8_soc_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                // in_clk_0.clk
		.in_rst_0_reset (otg_hpi_cs_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
